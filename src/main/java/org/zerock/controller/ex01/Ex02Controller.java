...
public class Ex02Controller {
		...
		public void method04() {
			System.out.println("/ex02/ex04, /ex02/ex05 일함");
		}
		@RequestMapping(value = {"sub06","sub07"})
		public void method05() {
			System.out.println("/ex02/ex06, /ex02/ex07 일함");
			// 하나의 메소드가 여러경로 가능
		}
		@RequestMapping(path = "sub08")
		public void method06() {
			System.out.println("/ex02/ex08 일함!!");
		}
		@RequestMapping(path = {"sub09, sub10"})
		public void method07() {
			System.out.println("/ex02/ex09 , /ex02/ex10 일함!!");
		}
}
